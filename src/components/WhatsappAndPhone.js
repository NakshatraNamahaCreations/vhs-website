...
function WhatsappAndPhone() {
  ...
  const getAllNumbers = async () => {
    let res = await axios.get(
      "https://api.vijayhomeservicebengaluru.in/api/userapp/getwhatsNumbers"
    );
    if (res.status === 200) {
      console.log(res);
  ...
  const deleteNumbers = async (id) => {
    axios({
      method: "delete",
      url: "https://api.vijayhomeservicebengaluru.in/api/userapp/deletenumbers/" + id,
    })
              ...
              <div className="card-body p-3">
                <form>
                  ...
                  <div className="row pt-3 justify-content-center">
                    <div className="col-md-2">
                      <button className=" vhs-button vucare_btn" onClick={addNumbers}>
                        Add
                      </button>
                    </div>
                  </div>
          ...
          <Modal.Body>
            <div className="card-body p-3">
              <form>
                ...
                <div className="row pt-3 justify-content-center">
                  <div className="col-md-2">
                    <button className=" vhs-button vucare_btn" onClick={editNumbers}>
                      Update
                    </button>
                  </div>
                </div>
