...
//   const [ vhsname, set vhsname] = useState("");
...
//     let res = await axios.get("https://api.vijayhomeservicebengaluru.in/api/getalltechnician");
//     if ((res.status = 200)) {
...
//     axios({
//       method: "post",
//       url: "https://api.vijayhomeservicebengaluru.in/api/deletetechnician/" + id,
//     })
...
//                         type="text"
//                         className="col-md-12  vhs-input-value"
//                         onChange={(e) => set vhsname(e.target.value)}
//                       />
//                     </div>
//                   </div>
//                 </div>
